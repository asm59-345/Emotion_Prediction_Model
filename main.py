...
# TensorFlow/Keras imports (optional - will fail gracefully if not installed)
try:
    ...
    print("Warning: TensorFlow not installed. Model predictions will not be available.")
...
class TextInput(BaseModel):
    text : str = Field(
        ...
        json_schema_extra={"example ": "I am feeling very happy today!"}
    )
